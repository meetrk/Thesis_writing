...
\begin{table}[htbp]
        \centering
        \includegraphics[width=0.75\textwidth]{figures/experiment3/graph_rea_wn18}
        \caption{Link prediction performance of Uncertainty Estimation Methods on WN18RR}
...
\begin{table}[htbp]
        \centering
        \includegraphics[width=0.75\textwidth]{figures/experiment3/graph_rea_fb15k}
        \caption{Link prediction performance of Uncertainty Estimation Methods on FB15K-237}
        \label{tab:reliability_diagram_fb15k_exp3}
\end{table}

\begin{table}[htbp]
        \centering
        \includegraphics[width=0.95\textwidth]{figures/experiment3/graph_wrr}
        \includegraphics[width=0.95\textwidth]{figures/experiment3/graph_fb15k}
        \caption{Uncertainty Metrics Analysis on WN18RR and FB15K-237 Datasets with Different Uncertainty Estimation Methods. Here Edge Dropout is denoted as ED and Label Smoothing as LS.}
