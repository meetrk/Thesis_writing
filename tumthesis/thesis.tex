...
\titleenglish{Quantifying Predictive Uncertainty in Knowledge Graph Link Prediction}
% \titlegerman{Quantifizierung der Vorhersageunsicherheit bei der Link-Vorhersage in Wissensgraphen}
\author{Meet~Kachhadiya}
\supervisor{\chairhead}
\assistants{Johannes~Mäkelburg\tlc{}~M.\,Sc.}

% Only needed for dissertation
\chairman{\makebox[7cm]{\dotfill}}
\advisor{Johannes~Mäkelburg, M.Sc}
